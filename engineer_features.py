...
def engineer_features(input_path, output_path):
    ...
    #ensuring that the date is sorted properly
    ...
    print(df_cleaned[['Date', 'Close', 'SMA_7', 'Close_Lag_1', 'Target_Next_Close']].head(3))
...
if __name__ == "__main__":
    ...
    engineer_features(CLEAN_PATH, FEATURES_PATH)